...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  th { background: #f1f3f5; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.5px; padding: 12px 16px; text-align: left; font-weight: 600; color: #555; border-bottom: 2px solid var(--border); cursor: pointer; user-select: none; white-space: nowrap; }
...
<div class="container">
  ...
  <div class="controls">
    ...
    <div class="control-group">
      ...
      <div class="control-row">
        <input type="range" id="minSemMonths" min="0" max="24" step="0.5" value="1">
        <span class="val" id="minSemMonthsVal">1</span>
        <input type="number" id="minSemMonthsNum" min="0" max="60" step="0.5" value="1" title="Type a custom value">
      </div>
    </div>
    <div class="control-group">
...
function render() {
  ...
  var result = compute(minM, minS, minT);
